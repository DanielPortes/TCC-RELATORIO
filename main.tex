...
\usepackage{placeins} % Para controlar a posição de figuras no texto
...
% --- Título e Autor ---
\titulo{Estudo comparativo de modelos para previsão horária de PM2,5}
\autor{Daniel Fagundes Portes Fernandes}
\nome{Daniel}
\ultimonome{Fernandes}

\hypersetup{
	pdftitle={Estudo comparativo de modelos para previsão horária de PM2,5},
