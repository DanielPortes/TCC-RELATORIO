...
% --- Título e Autor ---
\titulo{Estudo experimental comparativo de modelos para previsão horária de PM2,5}
\autor{Daniel Fagundes Portes Fernandes}
\nome{Daniel}
\ultimonome{Fernandes}

\hypersetup{
	pdftitle={Estudo experimental comparativo de modelos para previsão horária de PM2,5},
