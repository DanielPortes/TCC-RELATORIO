...
A avaliação de modelos de regressão multi-horizonte deve combinar métricas globais e métricas por horizonte. Métricas como MAE, RMSE e MAPE são amplamente usadas para avaliar acurácia de previsão \cite{hyndman2021forecasting}. O erro médio absoluto (MAE) mede a magnitude média dos erros e é menos sensível a valores extremos que o erro quadrático:
