...
\begin{table}[htb]
    ...
    \begin{tabular}{>{\raggedright\arraybackslash}p{0.19\textwidth}>{\raggedright\arraybackslash}p{0.23\textwidth}>{\raggedright\arraybackslash}p{0.48\textwidth}}
        ...
        \midrule
        Redes neurais & Taxa de aprendizado & 0{,}0003; 0{,}0005; 0{,}0008; 0{,}0012; 0{,}0018; 0{,}0025; 0{,}0035; 0{,}005; 0{,}007 \\
...
\begin{table}[htb]
    ...
    \begin{tabular}{>{\raggedright\arraybackslash}p{0.20\textwidth}>{\raggedright\arraybackslash}p{0.35\textwidth}>{\raggedright\arraybackslash}p{0.35\textwidth}}
        ...
        \midrule
        LSTM direta & dimensão oculta 256; 3 camadas; agregação por média & taxa de aprendizado 0{,}007; decaimento de pesos $5 \times 10^{-5}$; \textit{dropout} 0{,}20; $\delta$ da Huber 2{,}0 \\
        LSTM recursiva & dimensão oculta 128; 2 camadas & taxa de aprendizado 0{,}0035; decaimento de pesos 0; \textit{dropout} 0{,}20; $\delta$ da Huber 1{,}0 \\
        Seq2Seq L1 ponderada & codificador 96; decodificador 96; 1 camada; atenção de entrada 96; representação de horizonte 24 & taxa de aprendizado 0{,}007; decaimento de pesos $10^{-6}$; \textit{dropout} 0{,}30; pesos 1{,}20/1{,}10; fator de subestimação 1{,}50 \\
